...
E2E_CPU_GRADIENT_STAGING=${E2E_CPU_GRADIENT_STAGING:-False}
E2E_ACTIVATION_CPU_OFFLOAD=${E2E_ACTIVATION_CPU_OFFLOAD:-False}
...
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0,1,2,3} nohup torchrun \
  ...
  --e2e_cpu_gradient_staging "$E2E_CPU_GRADIENT_STAGING" \
  --e2e_activation_cpu_offload "$E2E_ACTIVATION_CPU_OFFLOAD" \
